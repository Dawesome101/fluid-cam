...
//     version 1.4.1
//     from Assets/Input System/InputActions_FluidCam.inputactions
//
...
public partial class @InputActions_FluidCam : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @InputActions_FluidCam()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""InputActions_FluidCam"",
    ""maps"": [
        {
    ...
    {
        private @InputActions_FluidCam m_Wrapper;
        public PlayerControllerActions(@InputActions_FluidCam wrapper) { m_Wrapper = wrapper; }
